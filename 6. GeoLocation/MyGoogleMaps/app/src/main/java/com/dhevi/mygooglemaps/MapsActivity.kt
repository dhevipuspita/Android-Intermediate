package com.dhevi.mygooglemaps
...
import com.dhevi.mygooglemaps.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.uiSettings.isZoomControlsEnabled = true //zoom kontrol
        mMap.uiSettings.isIndoorLevelPickerEnabled = true //detail lantai
        mMap.uiSettings.isCompassEnabled = true //compas
        mMap.uiSettings.isMapToolbarEnabled = true //toolbar
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
    ...
    private fun addManyMarker() {
        ...
        tourismPlace.forEach { tourism ->
            ...
            boundsBuilder.include(latLng) //agar otomatis zoom out marker
        }
